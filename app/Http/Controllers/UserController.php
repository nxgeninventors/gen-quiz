...
class UserController extends Controller
{
     ...
     */
    public function store(StoreUserRequest $request, CreateNewUser $createUser)
    {
    ...
    public function show(User $user)
    {
        ...
        return view('users.show', compact('user', 'roles', 'userHasRoles'));
    }
    ...
    public function accountInfo()
    {
        ...
        return view('users.account_info', compact('user'));
    }
